...
public:
	...
	void SetRotation(float x, float y, float z) { rotation_x_ = x; rotation_y_ = y; rotation_z_ = z; }

	const DirectX::XMFLOAT3 GetPosition()const { return DirectX::XMFLOAT3(position_x_, position_y_, position_z_); }

	const DirectX::XMFLOAT3 GetRotation()const { return DirectX::XMFLOAT3(rotation_x_, rotation_y_, rotation_z_); }
	...
	void Get2DViewMatrix(DirectX::XMMATRIX& view)const { view = _2D_view_matrix_; }
private:
