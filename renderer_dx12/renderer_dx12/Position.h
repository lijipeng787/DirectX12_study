...
public:
	...
	~Position() {}
public:
	void Position::SetPosition(float x, float y, float z) { position_x_ = x; position_y_ = y; position_z_ = z; }

	void Position::SetRotation(float x, float y, float z) { rotation_x_ = x; rotation_y_ = y; rotation_z_ = z; }

	void Position::GetPosition(float & x, float & y, float & z) { x = position_x_; y = position_y_; z = position_z_; }

	void Position::GetRotation(float & x, float & y, float & z) { x = rotation_x_; y = rotation_y_; z = rotation_z_; }
